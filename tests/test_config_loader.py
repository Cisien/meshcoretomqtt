...
class TestLoadConfigWithExplicitPaths:
    ...
    def test_multiple_config_files_overlay(self, tmp_path):
    ...
    def test_broker_overlay_merges_by_name(self, tmp_path):
    ...
    def test_skips_default_config_d(self, tmp_path, monkeypatch):
    ...
    def test_no_config_paths_returns_defaults(self):
